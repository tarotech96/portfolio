...
const Contact: React.FC<{ title: string }> = ({ title = "Contact me" }) => {
  return (
    <div className="main contact text-white flex flex-row space-x-4 lg:flex-col lg:h-full">
      <div className="left-section w-1/2 mt-14 ml-14 lg:w-full lg:ml-0">
        ...
        <p className="text-xl md:text-base leading-8 mt-8 break-all">
        ...
        <div className="contact-form mt-28">
          <form autoComplete="off">
            <div className="flex flex-row space-x-2">
              <input
                className="border-none outline-none rounded w-1/2 py-3 px-3 text-white bg-[#2B2B2B]"
                id="username"
                type="text"
                placeholder="Name"
              />
            ...
            <div className="mt-4 mb-4">
              <textarea
                className="border-none h-48 outline-none rounded w-full py-3 px-3 text-white bg-[#2B2B2B]"
                id="subject"
                placeholder="Message"
              />
            </div>
            <div className="float-right">
              <button className="contact-button border rounded border-[#03c5a9] px-6 py-2 text-[#03c5a9] text-xl font-medium hover:border-white ">
                Send message
              </button>
            </div>
          </form>
      ...
      <div className="right-section w-1/2 lg:w-full lg:mt-14">
        <iframe
